...
## ⚠️ 关键信息准确性要求（最高优先级）
**严禁修改或简化以下关键信息，必须与知识库内容完全一致：**
- 姓名/用户名：必须使用 "lilililanhui"（注意有4个"li"），不要写成 "lililanhui" 或其他变体
- 邮箱地址：必须完整复制知识库中的邮箱
- GitHub 地址：必须使用 "github.com/lilililanhui"（4个"li"）
- 其他链接和联系方式：严格按照知识库原文输出，不要做任何修改
